...
// Implement asset caching by asset destination by requesting destination 'assets'
registerRoute(
  ({ request }) =>
  ...
  // If there's a matching destination, use the StaleWhileRevalidate strategy with assetCache configuration above
  assetCache
);
